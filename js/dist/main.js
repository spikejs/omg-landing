...
},{"./libs/scopeSelector":12}],2:[function(require,module,exports){
'use strict';
...
(function (root, factory) {
    ...
    function canvid(params) {
        ...
        function canAnimFrame() {
            var cancelAnimationFrame = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.msCancelAnimationFrame || function (requestID) {
...
require('./polyfills/scrollingelement');

require('./polyfills/assign');

require('./polyfills/NodeList');

require('./polyfills/CSS.supports');

},{"./polyfills/CSS.supports":5,"./polyfills/NodeList":6,"./polyfills/assign":7,"./polyfills/classList":8,"./polyfills/matches":9,"./polyfills/scrollingelement":10}],5:[function(require,module,exports){
"use strict";
...
;(function () {
  ...
  function s(l) {
    function e() {
      var b = d.length - 1;0 > b && (t = !1);return d[b];
    }function a(c) {
      var l = d.length - 1;0 > l && (t = !1);b = d[l] = c;
    }function m(b, c, a, d) {
      r = a || h;var e, f, g;d && r--;do {
        if (a = l.charAt(++r), d) (g = a && (e || f), "'" == a || '"' == a) ? g = e = !e : e || (f || "(" != a ? f && ")" == a && (f = !1, g = !0) : g = f = !0);
      } while (g || a && !(b && a == b || c && a != c));if (null == b || a == b) return r;
    }l || s.a();var d = [],
        f,
        b,
        t = !0,
        ...
        h = -1,
        r,
        v = l.length;for (d.push(void 0); ++h < v;) {
      1 == c ? g = 40 : 2 == c || 4 == c || 32 == c ? g = 41 : 64 == c ? g = 39 : 16 == c ? g = 103 : 8 == c && (g = 16);f = l.charAt(h);
      if (g & 1 && "n" == f && "not" == l.substr(h, 3)) c = 1, h += 2;else if (g & 2 && "a" == f && "and" == l.substr(h, 3)) c = 2, h += 2;else if (g & 4 && "o" == f && "or" == l.substr(h, 2)) c = 4, h++;else if (g & 32 && "(" == f && m("(", " ")) c = 32, h = r - 1;else if (g & 64 && ")" == f && 1 < d.length) c = 64;else if (g & 8 && "(" == f && (n = m(null, " ")) && m(":", null, n)) {
        c = 8;h = r - 1;q = l.substr(n, h - n + 1).trim();n = 0;w = null;continue;
      } else if (g & 16 && (n = m(null, " ")) && m(")", null, n, !0)) c = 16, h = r, w = l.substr(n, h - n).trim(), n = 0, f = " ";else if (" " == f) continue;else c = 0;t && f && c & g || s.a();t = !0;if (4 == c) !1 === b ? (a(), u = !1) : !0 === b && (u = !0);else if (!u) if (b = e(), 1 == c) k = !0;else if (2 == c) !1 === b ? u = !0 : a();else {
        if (!1 !== b || c & 96) 32 == c ? d.push(void 0) : 64 == c ? (u = !1, d.pop(), void 0 !== e() && (b = !!(b & e())), k = !1) : 16 == c && (a(p(q, w)), k && (b = !b), k = !1, w = q = null);a(b);
      }
    }(!t || void 0 === b || 1 < d.length) && s.a();return b;
  }var a = window,
      p,
      v,
      q,
      k = a.CSS;k || (k = a.CSS = {});p = k.supports;!p && a.supportsCSS && (p = k.supports = a.supportsCSS.bind(a), a.__proto__ && delete a.__proto__.supportsCSS);if ("function" === typeof p) {
    var x;a: {
      try {
        p.call(k, "(a:a)");x = !(a = p = null);break a;
      } catch (y) {}x = void 0;
    }if (x) return;
  } else v = "runtimeStyle" in document.documentElement, a = a.document.createElement("_"), q = {}, p = function (a, e, k, m, d) {
    var f = m + "\\/" + d;if (f in q) return q[f];a = (m + "").replace(this, a);var b = m && d && a in e;if (b) if (v) {
      if (/\(|\s/.test(d)) try {
        e[a] = d, b = !!e[a];
      } catch (p) {
        b = !1;
      } else e.cssText = "display:none;height:0;width:0;visibility:hidden;position:absolute;position:fixed;" + m + ":" + d, document.documentElement.appendChild(k), b = k.currentStyle[a] == d, document.documentElement.removeChild(k);
    } else e.cssText = m + ":" + d, b = e[a], b = b == d || b && 0 < e.length;e.cssText = "";return q[f] = b;
  }.bind(/(-)([a-z])/g, function (a, e, k) {
    return k.toUpperCase();
  }, a.style, v ? a : null);s.a = function () {
    throw Error("SYNTAX_ERR");
  };k.supports = function (a, e) {
    if (!arguments.length) throw Error("WRONG_ARGUMENTS_ERR");return 1 == arguments.length ? s(a) : p(a, e);
  };a = a = null;
})();
...
if (typeof Element !== 'undefined' && !Element.prototype.matches) {
    ...
    if (!proto.matches) {
        proto.matches = function (selector) {
            var randomClass = this.__randomClass || (0, _StringUtils.randomString)('rc');
...
},{"../StringUtils":2}],10:[function(require,module,exports){
'use strict';
...
exports.getProportionSizes = getProportionSizes;
function getElementSizes(el, isInner) {
    var width = -1,
        height = -1;
    ...
    if (el === window) {
        ...
        width = Math[isInner ? "min" : "max"](body.scrollWidth, _doc.scrollWidth, body.offsetWidth, _doc.offsetWidth, _doc.clientWidth);

        height = Math[isInner ? "min" : "max"](body.scrollHeight, _doc.scrollHeight, body.offsetHeight, _doc.offsetHeight, _doc.clientHeight);
    } else if (el.nodeType) {
    ...
    return { width: width, height: height, isPortrait: isPortrait };
}

function calMaxWidth(width, contWidth, height, contHeight) {
    var proportion = contWidth / width;

    height = height * proportion;
    width = contWidth;

    var delta = (contHeight - height) / 2;
...
function calMaxHeight(width, contWidth, height, contHeight) {
    var proportion = contHeight / height;

    width = width * proportion;
    height = contHeight;

    var delta = (contWidth - width) / 2;
...
function getProportionSizes(container, el) {
    var _getElementSizes = getElementSizes(el, false),
        width = _getElementSizes.width,
        height = _getElementSizes.height,
        isElementPortrait = _getElementSizes.isPortrait;

    var originalWidth = width,
        originalHeight = height;

    var _getElementSizes2 = getElementSizes(container, true),
        contWidth = _getElementSizes2.width,
        contHeight = _getElementSizes2.height,
        isContainerPortrait = _getElementSizes2.isPortrait;
    ...
    if (maxWidth) {
        var _calMaxWidth = calMaxWidth(width, contWidth, height, contHeight),
            newWidth = _calMaxWidth.width,
            newHeight = _calMaxWidth.height,
            delta = _calMaxWidth.delta;

        if (delta > 0) {
            var _calMaxHeight = calMaxHeight(width, contWidth, height, contHeight),
                _newWidth = _calMaxHeight.width,
                _newHeight = _calMaxHeight.height,
                _delta = _calMaxHeight.delta;
        ...
        var _calMaxHeight2 = calMaxHeight(width, contWidth, height, contHeight),
            _newWidth2 = _calMaxHeight2.width,
            _newHeight2 = _calMaxHeight2.height,
            _delta2 = _calMaxHeight2.delta;

        if (_delta2 > 0) {
            var _calMaxWidth2 = calMaxWidth(width, contWidth, height, contHeight),
                _newWidth3 = _calMaxWidth2.width,
                _newHeight3 = _calMaxWidth2.height,
                _delta3 = _calMaxWidth2.delta;
    ...
    return {
        ...
        isElementPortrait: isElementPortrait,
        isContainerPortrait: isContainerPortrait,
        maxHeight: maxHeight,
        maxWidth: maxWidth
    };
}
...
},{"./StringUtils":2,"content-loaded":16}],13:[function(require,module,exports){
'use strict';
...
function calcVW(unitValue, returnAsPx) {
    var value = unitValue * (getScreenWidth() / 100);
...
function calcVH(unitValue, returnAsPx) {
    var value = unitValue * (getScreenHeight() / 100);
...
function calc(unitValueString, returnAsPx) {
    var unitValue = parseFloat(unitValueString);
...
function pxString(number) {
    ...
    var floatNumber = Number(number.toFixed(6));
...
exports.default = {
    ...
    isSupportedVmax: isSupportedVmax,
    calcVW: calcVW,
    calcVH: calcVH,
    calcVMin: calcVMin,
    calcVMax: calcVMax,
...
var _StringUtils = require('./libs/StringUtils');

var _canvid = require('./libs/canvid');

var _canvid2 = _interopRequireDefault(_canvid);

var _headhesive = require('headhesive');

var _headhesive2 = _interopRequireDefault(_headhesive);

var _proportionElementResizes = require('./libs/proportionElementResizes');

var _viewportUnits = require('./libs/viewportUnits');

var _viewportUnits2 = _interopRequireDefault(_viewportUnits);
...
var application = {
    start: function start() {
        ...
        var sections = this.sections = new _Sections.Sections('.omp-page_content', document, { sectionSelector: '.omp-page' }, {
            '.omp-page-1_5-video': {
                videoByDimensions: {
                    "video": {
                        "portrait": {
                ...
                _getContainer: function _getContainer() {
                    var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.__currentType;
                ...
                _setVideoSource: function _setVideoSource() {
                    var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.__currentType;
                    var videoDescription = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                    ...
                    if (type === 'video') {
                        ...
                        // }
                    } else if (type == 'canvas') {} else if (type == 'canvid') {
                ...
                _setPosition: function _setPosition(position, inPercent) {
                    var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.__currentType;
                    ...
                    if (type === 'video') {
                        ...
                        var frames = this.__canvidSrc.frames;
                        ...
                        if (inPercent) {
                            ...
                            frames = frames - 1;
                            var nextFrame = Math.round(frames * (position / 100));
                            if (nextFrame > frames) {
                                nextFrame = frames;
                            } else if (nextFrame < 0) {
                                nextFrame = 0;
                            ...
                            var currentFrame = this.__canvidControl.getCurrentFrame ? this.__canvidControl.getCurrentFrame() : null;
                            if (currentFrame != nextFrame) {
                                this.__canvisNextStopFrame = nextFrame;

                                var isRevers = currentFrame != null && nextFrame < currentFrame;
                ...
                _getSizes: function _getSizes() {
                    var _this = this;

                    var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.__currentType;

                    var videoByDimensions = this.videoByDimensions[type][this._isPortrait ? "portrait" : "landscape"];
                    var videoDescription = videoByDimensions["*"];
                    ...
                    try {
                        for (var _iterator = Object.keys(videoByDimensions)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var dimensionKey = _step.value;
                    ...
                    if (type === 'canvid') {
                        if (!videoDescription.onFrame) {
                            videoDescription.onFrame = function () {
                                _this._onCanvidFrame.call(_this);
                            };
                        }
                    }
                ...
                _setContainerPositions: function _setContainerPositions() {
                    var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.__currentType;
                    ...
                    if (type === 'canvid') {
                        var _getSizes2 = this._getSizes(),
                            _width = _getSizes2.width,
                            _height = _getSizes2.height;

                        if (_width != containerEl.width || _height != containerEl.height) {
                            containerEl.width = _width;
                            containerEl.height = _height;

                            needToRedraw = true;
                        }
                    }

                    var _getProportionSizes = (0, _proportionElementResizes.getProportionSizes)({ width: this._screenWidth, height: this._screenHeight }, this._getSizes()),
                        width = _getProportionSizes.width,
                        height = _getProportionSizes.height,
                        left = _getProportionSizes.left,
                        right = _getProportionSizes.right,
                        top = _getProportionSizes.top,
                        bottom = _getProportionSizes.bottom;
                ...
                _isSameVideo: function _isSameVideo(videoDescription) {
                    var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.__currentType;

                    if (type === 'canvid') {
                        if (this.__canvidControl && this.__canvidControl.getOpts) {
                            var _canvidControl$getOp = this.__canvidControl.getOpts(),
                                videos = _canvidControl$getOp.videos;

                            if (videos) {
                                var defaultClip = videos["clip1"];
                ...
                _initVideo: function _initVideo() {
                    ...
                    var _getElementSizes = (0, _proportionElementResizes.getElementSizes)(window, true),
                        width = _getElementSizes.width,
                        height = _getElementSizes.height,
                        isPortrait = _getElementSizes.isPortrait;
                    ...
                    var videoEl = this._videoEl = el.querySelector('video');
                    if (!videoEl.id) {
                        videoEl.id = (0, _StringUtils.randomString)('CanvasVideoPlayer_', '_video');
                    }
                    var canvasEl = this._canvasEl = el.querySelector('canvas');
                    if (!canvasEl.id) {
                        canvasEl.id = (0, _StringUtils.randomString)('CanvasVideoPlayer_', '_canvas');
                    }
                    var containerEl = this._containerEl = el.querySelector('.omp-page-1_5-video__container');
                    if (!containerEl.id) {
                        containerEl.id = (0, _StringUtils.randomString)('CanvasVideoPlayer_', '_container');
                    }

                    var type = 'canvid'; //'video','canvas'
                    ...
                    var needToRedraw = this._setContainerPositions();
                    var videoDescription = this._getSizes(type);
                    ...
                    if (type === 'canvid') {
                        ...
                        if (!this.__canvidControl) {
                            (function () {
                                var canvidControl = _this2.__canvidControl = (0, _canvid2.default)({
                                    selector: '#' + _this2._getContainer(type).id,
                                    videos: {
                                    ...
                                    loaded: function loaded() {
                                        var currentFrame = 0;
                                        var nextFrame = _this2.__canvisNextStopFrame;
                                        var isRevers = nextFrame != null && nextFrame < currentFrame;
                                        canvidControl.play('clip1', isRevers, null, canvidControl.__lastFrame);
                                        if (nextFrame == null) {
                                            canvidControl.pause();
                                        }

                                        _this2.el.classList.add('inited'); // Section inited
                                    }
                                });
                ...
                _playVideo: function _playVideo() {
                    var scrollTop = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._scrollTop;
                    ...
                    if (this.__currentType == 'canvid') {
                        ...
                        var percent = -20 + 100 - (offsetHeight - (scrollTop - offsetTop)) / 1.5 * 100 / offsetHeight;
                ...
                __onScroll: function __onScroll() {
                    var scrollTop = this._scrollTop = sections.getScrollTop();
        ...
        var header = new _headhesive2.default('#main_page_header', { offset: 200 });
        var mainPageElement = document.getElementById('main_page_element');
        main_page_element.appendChild(header.clonedElem);

        var logoEl = header.clonedElem.querySelector('.omp-page_header__logo');
        logoEl.parentElement.removeChild(logoEl);
    },
    _onScrollingStart: function _onScrollingStart(containerElement, activeElement) {
        activeElement.classList.remove('active');
        this._paused = true;
        // console.log(' <<< _onScrollingStart');
    },
    _onScrollingEnd: function _onScrollingEnd(containerElement, activeElement) {
...
(0, _contentLoaded2.default)().then(function () {
    ...
    */
    function emulateViewportUnits() {
        var vmaxOnly = _viewportUnits2.default.isSupported() && !_viewportUnits2.default.isSupportedVmax();

        if (_viewportUnits2.default.isScreenPortrait()) {
            find('main').style.fontSize = _viewportUnits2.default.calc('2.5vmax', true);
            ...
            find('main').style.fontSize = _viewportUnits2.default.calc('2.5vmin', true);
        }
        ...
        try {
            for (var _iterator2 = findAll('.omp-page')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var el = _step2.value;

                if (!el.classList.contains('.omp-page-5')) {
                    el.style.minHeight = _viewportUnits2.default.calc('100vh', true);
                }
            }
        } catch (err) {
            _didIteratorError2 = true;
        ...
        find('.omp-page-1').style.minHeight = _viewportUnits2.default.calc('180vh', true);
        ...
        try {
            for (var _iterator3 = findAll('.omp-page-3__imgs')[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                var _el2 = _step3.value;

                _el2.style.top = _viewportUnits2.default.calc('8vh', true);
            }
        } catch (err) {
            _didIteratorError3 = true;
            _iteratorError3 = err;
    ...
    if (!_viewportUnits2.default.isSupported() || !_viewportUnits2.default.isSupportedVmax()) {
...
},{"./Sections.js":1,"./libs/StringUtils":2,"./libs/canvid":3,"./libs/polyfills":4,"./libs/proportionElementResizes":11,"./libs/viewportUnits":13,"babel-polyfill":15,"content-loaded":16,"headhesive":311,"mobile-detect":312}],15:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":17,"core-js/shim":310,"regenerator-runtime/runtime":314}],16:[function(require,module,exports){
