/* https://github.com/Stanko/html-canvas-video-player/blob/gh-pages/js/canvas-video-player.js */
...
CanvasVideoPlayer.prototype.animate = function() {
    var self = this;

    if ( self.animationFrame ) {
        console.log(3);
        cancelAnimationFrame(self.animationFrame);
        self.animationFrame = void 0;
    }
    ...
    self.animationFrame = requestAnimationFrame(function(){
        ...
        if ( self.__needToCuntinue ) {
            self.__needToCuntinue = false;
            self.animate();
        }
    });
};
